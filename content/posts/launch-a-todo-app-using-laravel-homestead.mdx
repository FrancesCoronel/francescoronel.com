...
- While still in ~/Homestead folder, sudo nano /private/etc/hosts to edit the hosts file and add on [these two lines (refer below)](/blog/launch-a-todo-app-using-laravel-homestead#hosts)
...
- Edit the Homestead.yaml file to configure locations of code using nano ~/.homestead/Homestead.yaml and make thefolder and sites sections [look like this (refer below)](/blog/launch-a-todo-app-using-laravel-homestead#yaml-config)  ❗ Anytime you edit this Homestead.yaml file, you have to perform the next 3 steps in order for it to work, so let’s go ahead and do those now.
...
- You will also need to configure your environment for ds-todos by creating an .env file and [typing the following in (refer below)](/blog/launch-a-todo-app-using-laravel-homestead#env) using touch .env && nano .env
