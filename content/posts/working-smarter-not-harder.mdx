...
date: "2014-02-21"
excerpt: ""
featuredImage: "https://ktebrbhzg9wasky1.public.blob.vercel-storage.com/blog/63b28f0659086b2b888414e6_4K5btFJ.jpeg"
categories: ["blog"]
tags: ["career-advice"]
organizations: []
skills: []
...
- **Start off the day using 5 minutes to manage your time**-   Jot down to-dos and deadlines on a physical/electronic list whenever they arise (I use Evernote)
...
- **Defeat Procrastination**-   Keep note of progress with work through small notebook/task list (:idea: Evernote’s work great for this)
...
- **The When, Where, How**-   Try to fit in as many mini tasks as possible between classes
...
- **Take Smart Notes**-   Always go to class and try to take the best notes possible
...
- **Demote Assignments**-   Work a little bit each day on your assignments
...
- To decide how much time to spend on supplemental sources, follow this guideline-   readings that make an argument are more important than
...
- **Utilize your resources**-   Figure out exactly what the test will cover (either through the teacher, syllabus, etc.)
...
- **Conquer Material**-   Embrace quiz-and-recall method - very efficient (:idea: Quizlet helped me a ton with this sort of thing)
- Spread out memorization over several days
- **Invest in “Academic Disaster Insurance”**-   Eliminate the question marks for topics covered in class or from the reading that you don’t understand
...
- **Provide “A+” Answers**-   Look over the whole test first
...
*SO BASICALLY* focus on the easiest, most valuable questions that you understand first and then go in increasing difficulty to the rest of the problems…*baddabing baddaboom****Finally the book focused on how to effectively write essays and papers…***

- **Target a Titillating Topic**-   Start looking for an interesting topic early
- **Conduct a Thesis-Hunting Expedition**-   Start with general sources and then follow references to find more targeted sources where good thesis ideas often hide
- **Seek a Second Opinion**-   A thesis is not a thesis until the professor has approved it
- **Research like a Machine**-   Find sources
- Make personal copies of all sources-
- Annotate the material
- **Craft a Powerful Story**-   There is no shortcut to developing a well-balanced and easy-to-follow argument
...
- **Consult Your Expert Panel**-   Before starting to write, get some opinions on the essay from friends and family who are familiar with the material
- The more important the paper, the more people who should review it
- **Write Without the Agony**-   Follow your outline and articulate your points clearly
- Try not to write no more than 3- 5 pages per weekday or 5 - 8 days per weekend day
- **Fix, Don’t Fixate**-   Read paper carefully on your laptop to make sure your argument is clear, fix obvious errors, and rewrite where the flow needs improvement
