...
- reads two floats from the keyboard
- prints the sum of the two floats
- prints the difference of the two floats
- prints the square of the first float
- reads two integers from the keyboard
- computes the sum and product of the two integers
...
- and prints the integer in decimal, octal and hexadecimal notation
